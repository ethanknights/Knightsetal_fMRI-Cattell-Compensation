...
ggplot(extradf,aes(x=group,y=Log)) +
  geom_flat_violin(position = position_nudge(x = .2, y = 0),adjust =2,alpha=.5,size=1.5, fill = 'orchid1') +
  geom_point(position = position_jitter(width = .15), shape = 21, size = 3, colour = 'black', fill = "orchid1", stroke = 2) +
